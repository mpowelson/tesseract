...
//  {
//    std::cout << "distance(" << boost::get(boost::vertex_link, graph)[*vi]->getName() << ") = " << d[*vi] << ", ";
//    std::cout << "parent(" << boost::get(boost::vertex_link, graph)[*vi]->getName() << ") = " << boost::get(boost::vertex_link, graph)[p[*vi]]->getName() << std::endl;
//  }
//  std::cout << std::endl;
#endif
