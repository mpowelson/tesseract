...
namespace tesseract_scene_graph
{
  ...
  inline JointCalibrationPtr convert(const boost::shared_ptr<const urdf::JointCalibration>& calibration)
  {
  ...
  inline JointDynamicsPtr convert(const boost::shared_ptr<const urdf::JointDynamics>& dynamics)
  {
  ...
  inline JointLimitsPtr convert(const boost::shared_ptr<const urdf::JointLimits>& limits)
  {
  ...
  inline JointMimicPtr convert(const boost::shared_ptr<const urdf::JointMimic>& mimic)
  {
  ...
  inline JointSafetyPtr convert(const boost::shared_ptr<const urdf::JointSafety>& safety)
  {
  ...
  inline InertialPtr convert(const boost::shared_ptr<const urdf::Inertial>& inertial)
  {
  ...
  inline std::vector<tesseract_geometry::GeometryPtr> convert(const boost::shared_ptr<const urdf::Geometry>& geometry, ResourceLocatorFn locator, bool visual = true)
  {
   ...
   */
  inline MaterialPtr convert(const boost::shared_ptr<const urdf::Material>& material)
  {
   ...
   */
  inline VisualPtr convert(const boost::shared_ptr<const urdf::Visual>& visual, ResourceLocatorFn locator)
  {    
   ...
   */
  inline std::vector<CollisionPtr> convert(const boost::shared_ptr<const urdf::Collision>& collision, ResourceLocatorFn locator)
  {
  ...
  inline SceneGraphPtr parseURDFModel(const urdf::ModelInterfaceSharedPtr& urdf_model, ResourceLocatorFn locator)
  {
  ...
  inline SceneGraphPtr parseURDFString(const std::string& urdf_xml_string, ResourceLocatorFn locator)
  {
    return parseURDFModel(urdf::parseURDF(urdf_xml_string), locator);
  }

  inline SceneGraphPtr parseURDFFile(const std::string& path, ResourceLocatorFn locator)
  {
