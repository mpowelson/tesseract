...
macro(tesseract_target_compile_options target)
  ...
  elseif(ARG_PUBLIC)
    ...
    if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      if(CXX_FEATURE_FOUND EQUAL "-1")
          target_compile_options("${target}" PUBLIC -mno-avx ${warning_flags})
...
macro(tesseract_configure_package)
  ...
  file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/share/${PROJECT_NAME}/hook/ros_package_path.dsv "prepend-non-duplicate;ROS_PACKAGE_PATH;/share")
